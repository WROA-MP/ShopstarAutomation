...
WebUI.click(findTestObject('Shopstar/Login User/Page_Shopstar Viajes/Click Arrendadora Filter'))

WebUI.click(findTestObject('Shopstar/Login User/Page_Shopstar Viajes/Click Alamo'))
