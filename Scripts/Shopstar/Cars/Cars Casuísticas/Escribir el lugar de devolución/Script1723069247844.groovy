...
WebUI.setText(findTestObject('Object Repository/Page_Shopstar Viajes/input_Autos_pickUpLocation-autocomplete'), 'SJO')

WebUI.click(findTestObject('Object Repository/Page_Shopstar Viajes/li_Aeropuerto Intl Jorge Chvez, LIM, Per'))

WebUI.setText(findTestObject('Shopstar/Login User/Page_Shopstar Viajes/Devolucion'), 'SJO')
